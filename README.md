[![platform badge](https://img.shields.io/powershellgallery/p/PersistenceSniper?label=Platform)](https://www.powershellgallery.com/packages/PersistenceSniper/) [![version](https://img.shields.io/powershellgallery/v/PersistenceSniper?label=Powershell%20Gallery)](https://www.powershellgallery.com/packages/PersistenceSniper/) [![downloads](https://img.shields.io/powershellgallery/dt/PersistenceSniper?label=Downloads)](https://www.powershellgallery.com/packages/PersistenceSniper/) [![workflow](https://github.com/last-byte/PersistenceSniper/actions/workflows/main.yml/badge.svg)](https://www.powershellgallery.com/packages/PersistenceSniper/) 
...
</p><p>PersistenceSniper is a Powershell script that can be used by Blue Teams, Incident Responders and System Administrators to hunt persistences implanted in Windows machines. The script is also available on <a href=https://www.powershellgallery.com/packages/PersistenceSniper/1.0>Powershell Gallery</a>.</p></td>
  </tr>
</tbody>
</table>
