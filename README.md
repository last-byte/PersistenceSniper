...
- [x] [Office AI.exe Hijacking](https://twitter.com/laughing_mantis/status/1645268114966470662)
- [x] [Explorer Context Menu Hijacking](https://ristbs.github.io/2023/02/15/hijack-explorer-context-menu-for-persistence-and-fun.html)
- [x] [Service Control Manager Security Descriptor Manipulation](https://pentestlab.blog/2023/03/20/persistence-service-control-manager/)
- [x] [RunEx Key](https://attack.mitre.org/techniques/T1547/001/)
- [x] [RunOnceEx Key](https://attack.mitre.org/techniques/T1547/001/)
- [x] [.NET Startup Hooks DLL Sideloading](https://persistence-info.github.io/Data/dotnetstartuphooks.html)
